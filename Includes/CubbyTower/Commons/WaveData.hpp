...
const static WaveInfo WAVES[] = {
    { sizeof(WAVE_1_TIMES) / sizeof(int), WAVE_1_TIMES, WAVE_1_FACTORIES },
    { sizeof(WAVE_2_TIMES) / sizeof(int), WAVE_2_TIMES, WAVE_2_FACTORIES },
    { sizeof(WAVE_3_TIMES) / sizeof(int), WAVE_3_TIMES, WAVE_3_FACTORIES },
    { sizeof(WAVE_4_TIMES) / sizeof(int), WAVE_4_TIMES, WAVE_4_FACTORIES },
    { sizeof(WAVE_5_TIMES) / sizeof(int), WAVE_5_TIMES, WAVE_5_FACTORIES },
};
}  // namespace CubbyTower
